...
HD_PWD='/home/matthew/Matthew/UCT/2020/Embedded3/Embedded_Prac5/arpeggiator/arpeggiator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arpeggiator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arpeggiator.tcl -notrace
