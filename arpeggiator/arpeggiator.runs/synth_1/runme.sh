...
HD_PWD='/home/matthew/Matthew/UCT/2020/Embedded3/Embedded_Prac5/arpeggiator/arpeggiator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arpeggiator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arpeggiator.tcl
